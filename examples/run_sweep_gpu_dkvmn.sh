...
TEMPLATE_YAML=$(ls all_wandbs/"${DATASET}"_dkvmn_qid_0.yaml)
PATCHED_YAML="all_wandbs/${DATASET}_dkvmn_qid_0.patched.yaml"
...
base = pathlib.Path(f"models/dkvmn_tiaocan_{DATASET}/{DATASET}_dkvmn_qid_models")
