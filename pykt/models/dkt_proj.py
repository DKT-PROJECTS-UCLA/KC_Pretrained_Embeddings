...
class DKT(Module):
    def __init__(self, num_c, emb_size, dropout=0.1, emb_type='qid', pretrained_emb_path="", emb_path=None, proj_dim=None):
        ...
        self.lstm_layer = LSTM(self.proj_dim, self.proj_dim, batch_first=True)
        self.dropout_layer = Dropout(dropout)
        self.out_layer = Linear(self.proj_dim, self.num_c)
